...
const faqDefaults = { title: 'Frequently Asked Questions', subtitle: 'Get answers to common questions', questions: 'How does it work?,Is it customizable?,What frameworks are supported?', fontFamily: 'Inter', primaryColor: '#3b82f6' };
